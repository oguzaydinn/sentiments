...
/**
 * Save entity analysis for a subreddit using the same organized structure
 */
export async function saveEntityAnalysis(
  ...
  try {
    ...
    // Data is now clean and JSON-serializable (no Sets or complex objects)
